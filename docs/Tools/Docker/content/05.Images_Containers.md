...
```text
[Create a Dockerfile] --> [Define Base Image]
                                |
                                v
[Copy Application Files] <-- [Set Working Directory]
       |
       v
[Install Dependencies] --> [Expose Ports] --> [Build Docker Image]
                                                     |
                                                     v
[Access Application] <-- [Run Docker Container]
```
