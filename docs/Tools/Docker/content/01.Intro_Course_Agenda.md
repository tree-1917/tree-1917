...
```text
[Developer] --> [Docker CLI] --> [Docker Daemon]
                             |--> [Docker Images]
                             |--> [Containers] --> [Application] --> [Host System]
```
...
```text
[Code Commit] --> [Build] --> [Test] --> {Tests Passed?}
                                          |
                                    Yes --+--> [Deploy]
                                          |
                                    No  --+--> [Notify Developer]
...
```text
[Old Container] --> [New Container] --> [Health Check] --> {Healthy?}
                                                          |
                                                    Yes --+--> [Shift Traffic]
                                                          |
                                                    No  --+--> [Rollback]
