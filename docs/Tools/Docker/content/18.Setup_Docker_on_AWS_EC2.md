...
```text
[Write Dockerfile] --> [Define Services in docker-compose.yml]
                                     |
                                     v
[Containers Running] <-- [Run docker-compose up]
          |
          v
[Manage with Docker Commands]
```
